...
function TableCardBase({ table, order, onClick }: TableCardProps) {
  ...
  return (
    ...
    >
      <div className={`${isTakeawayTable(table.table_number) ? "text-lg sm:text-xl" : "text-2xl sm:text-3xl"} font-bold mb-1 leading-none whitespace-nowrap`}>{formatTableName(table.table_number)}</div>
